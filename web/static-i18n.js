    ...
    landing: {
      ja: {
        _meta: {
          ...
          description:
            'Talk Shuffleは、1on1・アイスブレイク・チームビルディングのきっかけに使える会話テーマアプリ。3Dサイコロとカードデッキで話題をランダムに決められます。無料・登録不要。',
          ogLocale: 'ja_JP',
        },
        ...
        feature3: '価値観・グループディスカッションなど目的別デッキ',
        feature4: '参加人数・プレイヤー名・タイマー設定',
        feature5: 'セッション履歴（端末内保存）',
        feature6: '日本語 / 英語対応',
        scenesTitle: 'こんな場面で',
        scene1: 'チームビルディング — 価値観カードで互いの優先順位を語る',
        scene2: '1on1 — 自己内省と成長のきっかけ作り',
        scene3: 'グループディスカッション — チームで深掘りするトピック',
        scene4: 'ランダムサイコロ — 雑談や創作のテーマ決め',
        privacyTitle: 'プライバシー',
        privacyBody: {
          html: true,
      ...
      en: {
        _meta: {
          ...
          description:
            'Talk Shuffle helps teams pick conversation topics for 1:1s, icebreakers, and team building. Roll 3D dice or draw themed card decks. Free, no sign-up.',
          ogLocale: 'en_US',
        },
        ...
        feature3: 'Decks for values, group discussion, and more',
        ...
        scene1: 'Team building — rank values together',
        scene2: '1:1s — reflection and growth prompts',
        scene3: 'Group discussion — topics to dig into as a team',
        scene4: 'Random dice — casual chats and creative prompts',
